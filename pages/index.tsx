...
const Code: FC<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>> = (
  props,
...
const IndexPage: NextPage = () => (
  <div className={styles.container}>
    <div className={styles.card}>
      ...
      <p>
        In general only <Code>.env.local</Code> or <Code>.env</Code> are needed for this, but the
        table also features the usage of <Code>.env.development</Code> and{' '}
      ...
      <p>
        <Code>.env.local</Code> is not added by the example, because it must be ignored by git, but
      ...
      <p>
        Variables in <Code>.env.production</Code> won't be available if the app is running in
        development:
      </p>
      <pre>
      ...
      <p>
        Similarly, variables in <Code>.env.development</Code> won't be available if the app is
      ...
      <p>
        <Code>.env</Code> will not overwrite any variables defined in <Code>.env.local</Code> or{' '}
        <Code>.env.development</Code>.
      </p>
    </div>
  </div>
